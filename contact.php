...
<main>
    <section class="contact">
        ...
        <div class="flex justify-center">
            <section class="contact-form mg2 flex">
                    ...
                    <form class="contact-input flex align-center column pdv2" action=""> 
                        ...
                        <div class="flex">
                            <div>
                                ...
                                <label for="radio2" class="radio-label color-white">SCD</label>
                            </div>
                            <div>
                                <input id="radio1" type="radio" name="option" value="Saga décor">
                                <label for="radio1" class="radio-label color-white">Saga décor</label>
                            </div>
                        </div>
                ...
                <div class="contact-right flex column align-center justify-around text-center pd2">
                    <h1 class="form-title">Multidécor</h1>
                    <div class="grey-line"></div>
